...
import com.example.EventTicketPlatform.domain.dtos.ErrorDto;
import com.example.EventTicketPlatform.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TicketNotFoundException.class)
    public ResponseEntity<ErrorDto> handleTicketTypeNotFoundException(TicketNotFoundException ex) {
